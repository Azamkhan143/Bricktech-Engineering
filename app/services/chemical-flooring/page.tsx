    ...
    <main className="bg-brand-dark min-h-screen text-white">
      ...
      <section className="py-24 bg-white/5 border-y border-white/10">
        <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-16 items-center">
          <ScrollReveal>
            <h2 className="text-3xl font-heading font-bold mb-6">Why Choose Our <br/>Chemical Flooring?</h2>
            <ul className="space-y-4">
              {[
                "High acid and alkali resistance",
                "Seamless and easy to sanitize",
                "Extreme impact and abrasion resistance",
                "Anti-skid safety textures available",
                "Long-lasting and cost-effective maintenance"
              ].map((item, i) => (
